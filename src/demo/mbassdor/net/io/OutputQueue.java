...
public class OutputQueue {
	 ...
	 */
	public boolean offer(IrcMessage message, long timeout, TimeUnit unit) throws InterruptedException {
	 ...
	 */
	public boolean invite(String nick, String channel) throws InvalidMessageParamException {
	 ...
	 */
	public boolean join(String channel) throws InvalidMessageParamException {
	 ...
	 */
	public boolean join(String channel, String key) throws InvalidMessageParamException {
	 ...
	 */
	public boolean kick(String channel, String nick) throws InvalidMessageParamException {
	 ...
	 */
	public boolean kick(String channel, String nick, String comment) throws InvalidMessageParamException {
	 ...
	 */
	public boolean mode(String target, String mode, String... params) throws InvalidMessageParamException {
	 ...
	 */
	public boolean names(String channel) throws InvalidMessageParamException {
	 ...
	 */
	public boolean nick(String nick) throws InvalidMessageParamException {
	 ...
	 */
	public boolean notice(String target, String text) throws InvalidMessageParamException {
	 ...
	 */
	public boolean part(String channel) throws InvalidMessageParamException {
	 ...
	 */
	public boolean ping(String server1) throws InvalidMessageParamException {
	 ...
	 */
	public boolean ping(String server1, String server2) throws InvalidMessageParamException {
	 ...
	 */
	public boolean pong(String daemon1) throws InvalidMessageParamException {
	 ...
	 */
	public boolean pong(String daemon1, String daemon2) throws InvalidMessageParamException {
	 ...
	 */
	public boolean privmsg(String target, String text) throws InvalidMessageParamException {
	 ...
	 */
	public boolean quit() throws InvalidMessageParamException {
	 ...
	 */
	public boolean quit(String comment) throws InvalidMessageParamException {
	 ...
	 */
	public boolean topic(String channel) throws InvalidMessageParamException {
	 ...
	 */
	public boolean topic(String channel, String topic) throws InvalidMessageParamException {
	 ...
	 */
	public boolean user(String user, String mode, String realName) throws InvalidMessageParamException {
